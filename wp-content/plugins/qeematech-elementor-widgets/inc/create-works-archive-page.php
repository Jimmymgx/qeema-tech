	...
	$grid_section = array(
		...
		'elements' => array(
			qeema_works_archive_page_widget( 'qeema-portfolio-archive', array(
				...
				'all_label'      => 'الكل',
				'badge'          => 'معرض الأعمال',
				'heading'        => 'قصص نجاح تقنية صنعناها لشركائنا',
				'subheading'     => 'استكشف سابقة أعمالنا وتعرف على كيفية تحويل أفكار عملائنا إلى منصات رقمية تتصدر المنافسة في مختلف القطاعات.',
